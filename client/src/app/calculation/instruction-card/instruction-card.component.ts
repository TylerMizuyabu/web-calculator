...
export class InstructionCardComponent implements OnInit {
  ...
  static readonly functionDescriptions: [string, string][] = [
    [minFn.positiveIdentifier, 'max function returns the minimum of two numbers/expressions. Requires exactly 2 arguments'],
    ...
    [sinFn.positiveIdentifier, 'sin function returns the sine of a number/expression'],
